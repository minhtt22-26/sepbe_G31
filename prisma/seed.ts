...
//       'Công nhân vận hành máy SMT',
//       'Nhân viên QC điện tử',
//       'Kỹ thuật viên sửa chữa bo mạch',
//       'Công nhân đóng gói sản phẩm điện tử',
...
//       'Thợ cắt vải công nghiệp',
//       'Chuyền trưởng may',
//       'Công nhân kiểm hóa thành phẩm',
//       'Thợ ủi hoàn thiện',
//       'Công nhân đế giày',
//       'Thợ gò giày',
//     ],
...
//     occupations: [
//       'Công nhân vận hành máy ép nhựa',
//       'Công nhân thổi màng nhựa',
//       'Công nhân in ống đồng',
//       'Nhân viên QC nhựa – bao bì',
//       'Công nhân pha chế cao su',
//       'Công nhân đùn ống nhựa',
//     ],
//     taskPool: [
...
//       'Thợ mộc nội thất',
//       'Công nhân sơn gỗ',
//       'Công nhân lắp ráp nội thất',
//       'Nhân viên QC gỗ',
//       'Công nhân chà nhám',
//       'Công nhân vận hành máy CNC gỗ',
//     ],
//     taskPool: [
...
//     occupations: [
//       'Công nhân lắp ráp ô tô',
//       'Công nhân sản xuất linh kiện xe máy',
//       'Kỹ thuật viên sơn xe',
//       'Công nhân dập khuôn',
//       'Nhân viên QC phụ tùng',
//       'Thợ hàn khung xe',
//     ],
//     taskPool: [
...
//       'Nhân viên QC hóa chất',
//       'Công nhân đóng gói dược phẩm',
//       'Nhân viên phòng thí nghiệm',
//       'Công nhân vận hành lò phản ứng',
//       'Nhân viên an toàn hóa chất',
//     ],
//     taskPool: [
...
//   'Kiểm hàng KCS/QC',
//   'Đóng gói sản phẩm tốc độ cao',
//   'Sắp xếp kho bãi',
//   'Lái xe nâng',
//   'Quản lý chuyền sản xuất',
//   'Tuân thủ 5S/ISO',
//   'Làm việc xoay ca',
//   'Chịu áp lực sản lượng',
//   'Lắp ráp linh kiện PCB',
//   'Vận hành máy dập',
//   'Pha chế hóa chất',
//   'Vận hành lò hơi',
...
//   'Tiếng Anh giao tiếp công xưởng',
//   'Tiếng Hàn/Nhật cơ bản',
...
//   const salary =
//     faker.number.int({ min: 7, max: 15 }) + (Math.random() < 0.5 ? 0.5 : 0)
//   const templates = [
...
// ): string {
//   const sector =
//     SECTORS_DATA.find((s) => s.name === sectorName) || SECTORS_DATA[0]
...
//   const taskList = mixedTasks
//     .slice(0, numTasks)
//     .map((t) => `${b} ${t}`)
//     .join('\n')
//   const reqList = mixedReqs
//     .slice(0, numReqs)
//     .map((r) => `${b} ${r}`)
//     .join('\n')
//   const benList = mixedBens
//     .slice(0, numBens)
//     .map((bn) => `${b} ${bn}`)
//     .join('\n')
...
//     ])
//     return (
//       `TUYỂN GẤP ${occupation.toUpperCase()} TẠI ${province.toUpperCase()}\n\n` +
...
//   }
//   console.log(
//     `✅ Đã tạo ${SECTORS_DATA.length} ngành và ${occupations.length} vị trí`,
//   )
...
//           expectedSalary:
//             faker.number.int({ min: 6, max: 18 }) * 1000000 +
//             (Math.random() < 0.5 ? 500000 : 0),
...
//     } else {
//       email = `employer_${faker.string.alphanumeric(6)}@company.vn`
//         .toLowerCase()
//         .trim()
//     }
...
//       {
//         key: MatchingConfigKey.MIN_SCORE_THRESHOLD,
